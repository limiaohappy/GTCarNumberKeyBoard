...
- (void)showFromButton:(UIButton *)button{
    ...
    if ([button.currentTitle.lowercaseString isEqualToString:@"q"] || [button.currentTitle isEqualToString:@"1"] || [button.currentTitle isEqualToString:@"~"]|| [button.currentTitle isEqualToString:@"京"]|| [button.currentTitle isEqualToString:@"吉"]|| [button.currentTitle isEqualToString:@"甘"]) {           // 按钮在左边的情形
    ...
    } else if ([button.currentTitle.lowercaseString isEqualToString:@"p"] || [button.currentTitle isEqualToString:@"0"] || [button.currentTitle isEqualToString:@"#"]|| [button.currentTitle isEqualToString:@"沪"]|| [button.currentTitle isEqualToString:@"湘"]|| [button.currentTitle isEqualToString:@"新"]) {           // 按钮在右边的情形
...
- (void)showFromButtonBig:(UIButton *)button{
    if (button == nil) {
        return;
    }
    self.titleLetter.text = button.currentTitle;
    ...
    CGFloat popViewW = AUTO_ADAPT_SIZE_VALUE(72, 82, 88);
//    CGFloat widthxx =AUTO_ADAPT_SIZE_VALUE(72, 82, 88);
//    CGFloat popViewW = widthxx *41.0 /36;
    CGFloat popViewH = AUTO_ADAPT_SIZE_VALUE(100, 108, 118);
    CGFloat popViewX = 0;
    ...
    if ([button.currentTitle.lowercaseString isEqualToString:@"q"] || [button.currentTitle isEqualToString:@"1"] || [button.currentTitle isEqualToString:@"~"]|| [button.currentTitle isEqualToString:@"京"]|| [button.currentTitle isEqualToString:@"吉"]|| [button.currentTitle isEqualToString:@"甘"]) {           // 按钮在左边的情形
        ...
        popViewX = btnFrame.origin.x - AUTO_ADAPT_SIZE_VALUE(4, 4, 4);
        self.letterLeadingConstraint.constant = AUTO_ADAPT_SIZE_VALUE(9, 11, 11);
    } else if ([button.currentTitle.lowercaseString isEqualToString:@"p"] || [button.currentTitle isEqualToString:@"0"] || [button.currentTitle isEqualToString:@"#"]|| [button.currentTitle isEqualToString:@"沪"]|| [button.currentTitle isEqualToString:@"湘"]) {           // 按钮在右边的情形
        self.backImageView.image = [UIImage imageNamed:@"keyboard_pop_right"];
        popViewX = btnFrame.origin.x + btnFrame.size.width - AUTO_ADAPT_SIZE_VALUE(69, 79, 85);
        self.letterLeadingConstraint.constant = AUTO_ADAPT_SIZE_VALUE(25, 29, 33);
    } else {                                            // 按钮在中间部分
